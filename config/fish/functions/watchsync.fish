# Source: https://github.com/paulirish/dotfiles/blob/master/.config/fish/functions/watchsync.fish
function watchsync
  #
  ...
  cd "$local"
  fswatch . "date +%H:%M:%S && rsync -iru --size-only --exclude .DS_Store $excludeGit $excludeFromGitignore --delete . \"$remote\""
end
